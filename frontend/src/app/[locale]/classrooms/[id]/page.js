              ...
              <div className="flex flex-col items-center space-y-2 max-w-2xl">
                  <div className="flex items-center gap-2">
                    ...
                    <h1
                      className={cn(
                        "text-4xl",
                        theme === "dark" ? "text-white" : "text-gradient bg-clip-text text-black"
                      )}
                  ...
                  <div className="flex items-center gap-4">
                    <div className="flex items-center gap-2">
                      <svg xmlns="http://www.w3.org/2000/svg" 
                        className={cn("h-5 w-5", theme === "dark" ? "text-white stroke-white" : "stroke-current")} 
                        fill="none" 
                        viewBox="0 0 24 24" 
                        stroke="currentColor"
                      >
        ...
        {activeTab === 'students' ? (
          <div className={cn("rounded-xl shadow-lg p-6 border", 
            ...
            <div className="flex justify-between items-center mb-6">
              <h2 className={cn("text-2xl font-bold flex items-center gap-2", 
