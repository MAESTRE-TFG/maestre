          ...
          >
            {isGenerating ? (
              <div className="flex items-center justify-center">
                ...
                {window.location.pathname.includes('test-maker') ? t2("buttons.generating") : t("buttons.generating")}
              </div>
            ) : (
                window.location.pathname.includes('test-maker') ? t2("buttons.generateExam") : t("buttons.generateExam")
            )}
          </button>
        </div>
      </div>
