...
`;
  ...
  return (
    ...
    <div className="relative">
      ...
      <div className={cn(
        "w-full max-w-7xl mx-auto px-4 sm:px-8 md:px-12 lg:px-16 mb-6 p-4 rounded-md border text-sm",
        theme === "dark" ? "bg-zinc-800/80 border-amber-700 text-amber-200" : "bg-amber-50 border-amber-300 text-amber-800"
      )}>
